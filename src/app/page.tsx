    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-20 pb-16 bg-gradient-to-br from-primary-50 via-white to-secondary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-secondary-900 leading-tight mb-6">
            ...
            <div className="flex items-center justify-center gap-2 text-secondary-600 mb-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-secondary-50 rounded-2xl p-8 hover:shadow-lg transition-all duration-200 hover:-translate-y-1">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex items-center justify-center gap-2 text-secondary-600 mt-6">
            <CheckCircleIcon className="w-5 h-5 text-success-500" />
